...
var file_chat_proto_rawDesc = []byte{
	...
	0x79, 0x32, 0x6f, 0x0a, 0x0b, 0x43, 0x68, 0x61, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x28, 0x01, 0x42, 0x07, 0x5a, 0x05, 0x2f, 0x63, 0x68, 0x61, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
func (c *chatServiceClient) BroadCastMessage(ctx context.Context, opts ...grpc.CallOption) (ChatService_BroadCastMessageClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ChatService_serviceDesc.Streams[0], "/chat.ChatService/BroadCastMessage", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *chatServiceBroadCastMessageClient) CloseAndRecv() (*Message, error) {
...
func (x *chatServiceBroadCastMessageServer) SendAndClose(m *Message) error {
